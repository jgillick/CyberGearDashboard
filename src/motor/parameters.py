...
Parameters = (
    ...
    # (0x2007, "limit_torque", TYPE_FLOAT, (0, 12), READ_WRITE),
    ...
    # (0x2011, "cur_filt_gain", TYPE_FLOAT, (0, 1), READ_WRITE),
    # (0x2012, "cur_kp", TYPE_FLOAT, (0, 200), READ_WRITE),
    # (0x2013, "cur_ki", TYPE_FLOAT, (0, 200), READ_WRITE),
    # (0x2014, "spd_kp", TYPE_FLOAT, (0, 200), READ_WRITE),
    # (0x2015, "spd_ki", TYPE_FLOAT, (0, 200), READ_WRITE),
    # (0x2016, "loc_kp", TYPE_FLOAT, (0, 200), READ_WRITE),
    (0x2017, "spd_filt_gain", TYPE_FLOAT, (0, 1), READ_WRITE),
    # (0x2018, "limit_spd", TYPE_FLOAT, (0, 200), READ_WRITE),
    # (0x2019, "limit_cur", TYPE_FLOAT, (0, 23), READ_WRITE),
    ...
    # (0x300C, "VBUS", TYPE_FLOAT, None, READ_ONLY),
    ...
    # (0x3014, "rotation", TYPE_INT16, None, READ_ONLY),
    (0x3015, "modPos", TYPE_FLOAT, None, READ_ONLY),
    # (0x3016, "mechPos", TYPE_FLOAT, None, READ_ONLY),
    # (0x3017, "mechVel", TYPE_FLOAT, None, READ_ONLY),
    ...
    # (0x301E, "iqf", TYPE_FLOAT, None, READ_ONLY),
    ...
    #
    # Second table of parameters
    (0x7005, "run_mode", TYPE_UINT8, None, READ_WRITE),
    ...
    (0x7010, "cur_kp", TYPE_FLOAT, None, READ_WRITE),  # Kp of current
    (0x7011, "cur_ki", TYPE_FLOAT, None, READ_WRITE),  # Current Ki
    (
        0x7014,
        "cur_filt_gain",
        TYPE_FLOAT,
    ...
    (0x7016, "loc_ref", TYPE_FLOAT, None, READ_WRITE),  # Position mode angle command
    ...
    (0x701E, "loc_kp", TYPE_FLOAT, None, READ_WRITE),  # kp of position
    (0x701F, "spd_kp", TYPE_FLOAT, None, READ_WRITE),  # Speed in kp
    (0x7020, "spd_ki", TYPE_FLOAT, None, READ_WRITE),  # Speed of ki
)
